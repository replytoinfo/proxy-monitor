...
| `/edit` | заменить хост/порт/доступы, сохраняя id, группу, метку и историю проверок |
| `/list` | список с состоянием |
| `/status` | сводка по мониторингу |
| `/quality` | качество с момента последнего сброса (медиана за окно хранения) |
| `/qreset` | сбросить счётчики качества для всех прокси |
| `/speed [id\|группа]` | замер скорости скачивания по требованию |
